...
{
    std::vector<std::string> commands = SplitCommands(command.ToAnsiString());
...
void Scene::ProcessCommand(const std::string& command) 
{
    ...
    if (mainCmd == "help") 
    {
        ...
        if(subCmd == "")
        {
            Debug.ARLIMessage(ARLIM.help);
        }
        else if(subCmd == "system")
        {
            Debug.ARLIMessage(ARLIM.helpSystem);
        }
        else if(subCmd == "window")
        {
            Debug.ARLIMessage(ARLIM.helpWindow);
        }
        else if(subCmd == "screen")
        {
            Debug.ARLIMessage(ARLIM.helpScreen);
        }
        else if(subCmd == "stop")
        {
            Debug.ARLIMessage(ARLIM.helpStop);
        }
        else if(subCmd == "play")
        {
            Debug.ARLIMessage(ARLIM.helpPlay);
        }
        else if(subCmd == "help")
        {
            Debug.ARLIMessage(ARLIM.helpHelp);
        }
        else if(subCmd == "standby")
        {
            Debug.ARLIMessage(ARLIM.helpStandby);
        }
        else if(subCmd == "grid scale")
        {
            Debug.ARLIMessage(ARLIM.helpGridScale);
        }
        else if(subCmd == "grid size")
        {
            Debug.ARLIMessage(ARLIM.helpGridSize);
        }
        else if(subCmd == "change to")
        {
            Debug.ARLIMessage(ARLIM.helpChangeTo);
        }
        else if(subCmd == "add object")
        {
            Debug.ARLIMessage(ARLIM.helpAddObject);
        }
        else if(subCmd == "add component")
        {
            Debug.ARLIMessage(ARLIM.helpAddComponent);
        }
        else if(subCmd == "delete object")
        {
            Debug.ARLIMessage(ARLIM.helpDeleteObject);
        }
        else if(subCmd == "delete component")
        {
            Debug.ARLIMessage(ARLIM.helpDeleteComponent);
        }
        else if(subCmd == "enable object")
        {
            Debug.ARLIMessage(ARLIM.helpEnableObject);
        }
        else if(subCmd == "disable component")
        {
            Debug.ARLIMessage(ARLIM.helpDisableComponent);
        }
        else if(subCmd == "disable object")
        {
            Debug.ARLIMessage(ARLIM.helpDisableObject);
        }
        else if(subCmd == "set object")
        {
            Debug.ARLIMessage(ARLIM.helpSetObject);
        }
        else if(subCmd == "set component")
        {
            Debug.ARLIMessage(ARLIM.helpSetComponent);
        }
        else
        {
            Debug.ARLIMessage("Unknown Command {}\n\nUse help for more info.\n", {subCmd});
        }
    } 
